      ...
      <div class="row align-items-center">
          <div class="col-lg-6 mb-4 mb-lg-0">
              ...
              <div class="d-grid gap-2 d-md-flex">
                  <a href="{{ route('register') }}?role=landlord" class="btn btn-primary btn-lg px-4 py-3">Register as a Landlord</a>
                  <a href="{{-- route('landlord.learn-more') --}}" class="btn btn-outline-primary btn-lg px-4 py-3">Learn More</a>
              </div>
          </div>
...
<section id="featured-rooms" class="py-5" style="background-color: rgb(255,245,237);">
  <div class="container">
      <div class="row mb-4">
          <div class="col-12">
